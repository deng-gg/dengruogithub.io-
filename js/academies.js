window.onload = () => {
    ...
    slipone(number[0], exone, extwo);

    slip(number[1], number[7], exone, extwo);

    slipone(number[2], exone, extwo);

    sliptwo(number[3], exone, extwo);

    slipone(number[4], exone, extwo);

    sliptwo(number[5], exone, extwo);

    slipone(number[6], exone, extwo);

    sliptwo(number[8], exone, extwo);
